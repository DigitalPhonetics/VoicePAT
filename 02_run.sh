...
python run_evaluation.py --config configs/eval_pre_from_anon_datadir.yaml


#train post ASV using anonymized libri-360 and perform libri dev+test post evaluation
#ASV training takes 2hours
python run_evaluation.py --config configs/eval_post_scratch_from_anon_datadir.yaml 
