...
MAMBA_PACKAGES_TO_INSTALL="sshpass sox libflac inotify-tools git-lfs ffmpeg wget cmake ncurses ninja python=3.10 nvtop automake libtool gxx=12.3.0 gcc=12.3.0 python-sounddevice tqdm"
